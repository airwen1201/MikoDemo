...
@interface SQAdvertisingScrollView () <UIScrollViewDelegate>
...
@implementation SQAdvertisingScrollView
...
- (void)setup {
    ...
    titleBg.alpha = 0.5;
    [titleBg addSubview:self.titleLabel];
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.right.bottom.left.equalTo(titleBg);
    }];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.titleArray) {
        self.titleLabel.text = self.titleArray[page-1];
    }
